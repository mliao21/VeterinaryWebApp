...
const Admin = ({animals}) => {
    ...
    return (
        <header className="title">
            <div className="is-size-2 has-text-primary-dark has-background-primary-light" css={css`display: flex; align-items: center;`}>
                ...
                <div className="column has-text-right">
                    <button
                        ...
                        className={`button is-medium ${inEditMode ? "is-info" : "is-primary"}`}>
